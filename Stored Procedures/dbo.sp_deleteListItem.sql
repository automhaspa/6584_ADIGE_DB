...
CREATE PROCEDURE [dbo].[sp_deleteListItem]
@Id_Dettaglio INT
-- Parametri Standard;
...
BEGIN
	...
	BEGIN TRY	
		...
		DELETE FROM dbo.Lista_Uscita_Dettaglio WHERE Id_Dettaglio = @Id_Dettaglio
		DELETE FROM dbo.Liste_Dettaglio WHERE Id_Dettaglio = @Id_Dettaglio
