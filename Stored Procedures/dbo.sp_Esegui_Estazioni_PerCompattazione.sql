...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[sp_Esegui_Estazioni_PerCompattazione]
	-- Parametri Standard;
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			SELECT	@Posizioni_Buffer = COUNT(P.ID_PARTIZIONE) - COUNT(CASE WHEN UP.Id_Udc IS NULL THEN NULL ELSE 1 END)
