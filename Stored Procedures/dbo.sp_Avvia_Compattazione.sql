...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[sp_Avvia_Compattazione]
	--Id della Testata
...
BEGIN
	...
	BEGIN TRY
		...
		DECLARE @NEW_VALORE VARCHAR(50)

		SET @NEW_VALORE  = CASE WHEN @Attivata = 1 THEN 'True' ELSE 'False' END
        
		SELECT	@PARAMETRO = PG.Id_Parametro
		...
		IF (@PARAMETRO IS NULL)
			THROW 50001,'IMPOSSIBILE AVVIARE LA COMPATTAZIONE SULLA BAIA SELEZIONATA',1
