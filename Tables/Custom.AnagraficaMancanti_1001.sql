CREATE TABLE [Custom].[AnagraficaMancanti_1001]
(
[Id_Testata] [int] NOT NULL,
[Id_Riga] [int] NOT NULL,
[Id_Articolo] [int] NOT NULL,
[Qta_Mancante] [numeric] (10, 2) NOT NULL CONSTRAINT [DF__Anagrafic__Qta_M__2C738AF2] DEFAULT ((0)),
...
GO
ALTER TABLE [Custom].[AnagraficaMancanti_1001] ADD CONSTRAINT [PK__Anagrafi__4AFA07B64593D821] PRIMARY KEY CLUSTERED ([Id_Testata], [Id_Riga]) ON [PRIMARY]
GO
