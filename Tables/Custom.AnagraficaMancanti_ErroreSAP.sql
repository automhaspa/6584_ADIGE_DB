CREATE TABLE [Custom].[AnagraficaMancanti_ErroreSAP]
(
...
GO
ALTER TABLE [Custom].[AnagraficaMancanti_ErroreSAP] ADD CONSTRAINT [PK__AnagraficaMancantiSAP] PRIMARY KEY CLUSTERED ([Id_Testata], [Id_Riga]) ON [PRIMARY]
GO
